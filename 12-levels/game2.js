...
var enemies = {
    ...
    straight: { x: 0,   y: -150, sprite: 'enemy_ship', health: 10, 
		E: 100 },
    ...
    ltr:      { x: 0,   y: -150, sprite: 'enemy_purple', health: 10, 
		B: 150, C: 10, E: 260  },
    ...
    //  van bajando.
    wiggle:   { x: 250, y: -150, sprite: 'enemy_bee', health: 20, 
		B: 50, C: 4, E: 100 },
    step:     { x: 0,   y: -200, sprite: 'enemy_circle', health: 10,
		B: 150, C: 0.8, E: 75 },

    final:    { x: 0,   y: -50, sprite: 'enemy_purple', health: 1000,
		E: 10 }
...
var level1 = [
  //  Comienzo, Fin,   Frecuencia,  Tipo,       Override
    [ 0,        4000,   700,       'step',       {y: 160}   ],
    [ 2000,    4000,   200,        'ltr',       { x: 140 }  ],        
    [ 3000,    22000,  400,        'circle',    { x: 200, y: 140}  ],
    [ 5800,    7000,   500,        'straight',  { x: 10  }  ],
    [ 5800,    7000,   500,        'straight',  { x: 60  }  ],
    [ 5800,    7000,   500,        'straight',  { x: 110 }  ],
    [ 5800,    7000,   500,        'straight',  { x: 160  } ],
    [ 5800,    7000,   500,        'straight',  { x: 210  } ],
    [ 5800,    7000,   500,        'straight',  { x: 260  } ],
    [ 10000,   25000, 100000,      'final',     { x: 140  } ],
    [ 8000,   19000,   4000,       'straight_2',{ x: 10 }   ],
    [ 8000,   19000,   4000,       'straight_2',{ x: 140 }  ],
    [ 8000,   19000,   4000,       'straight_2',{ x: 260 }  ],
    [ 22000,   25000,  400,        'wiggle',    { x: 260 }  ],
    [ 22000,   25000,  400,        'wiggle',    { x: 140 }  ],
    [ 22000,   25000,  400,        'wiggle',    { x: 10 }   ]
];
