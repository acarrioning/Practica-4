...
var enemies = {
    ...
    straight_: { x: 0,   y: -150, sprite: 'enemy_ship', health: 10, 
		E: 100 },
    straight_2: { x: 0,   y: -150, sprite: 'enemy_ship', health: 10, A: 11, B: -50, 
		E: 50, F: 100, G: 1, H: Math.PI/2},
    ...
    //  van bajando.
    wiggle_:   { x: 250, y: -150, sprite: 'enemy_bee', health: 20, 
		B: 50, C: 4, E: 100 },
    step_:     { x: 0,   y: -200, sprite: 'enemy_circle', health: 10,
		B: 150, C: 0.8, E: 75 },

    final_:    { x: 0,   y: -50, sprite: 'enemy_purple', health: 1000,
		E: 10 },
...
var level2 = [
  //  Comienzo, Fin,   Frecuencia,  Tipo,       Override
    [ 0,        4000,   700,       'step_',       {y: 160}   ],
    [ 2000,    4000,   200,        'ltr_',       { x: 140 }  ],        
    [ 3000,    22000,  400,        'circle_',    { x: 200, y: 140}  ],
    [ 5800,    7000,   500,        'straight_',  { x: 10  }  ],
    [ 5800,    7000,   500,        'straight_',  { x: 60  }  ],
    [ 5800,    7000,   500,        'straight_',  { x: 110 }  ],
    [ 5800,    7000,   500,        'straight_',  { x: 160  } ],
    [ 5800,    7000,   500,        'straight_',  { x: 210  } ],
    [ 5800,    7000,   500,        'straight_',  { x: 260  } ],
    [ 10000,   25000, 100000,      'final_',     { x: 140  } ],
    [ 8000,   19000,   4000,       'straight_2',{ x: 10 }   ],
    [ 8000,   19000,   4000,       'straight_2',{ x: 140 }  ],
    [ 8000,   19000,   4000,       'straight_2',{ x: 260 }  ],
    [ 22000,   25000,  400,        'wiggle_',    { x: 260 }  ],
    [ 22000,   25000,  400,        'wiggle_',    { x: 140 }  ],
    [ 22000,   25000,  400,        'wiggle_',    { x: 10 }   ]
];
...
var playGame2 = function() {
    ...
    // nivel level1 y la función callback a la que llamar si se ha
    // ganado el juego
    board.add(new Level(level2, winGameEnd));
    Game.setBoard(3,board);
};

var winGameEnd = function(){
    Game.setBoard(3,new TitleScreen("whole game complete!", 
